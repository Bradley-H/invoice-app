      ...
      return `<div class="bottomCard_invoiceInfo svelte-lswt2h"><div class="bottomCard_invoiceInfo-details svelte-lswt2h"><div class="bottomCard_invoiceInfo-ID svelte-lswt2h">${validate_component(Text, "Text").$$render(
        ...
        {}
                    ...
                    <div class="bottomCard_invoiceInfo-billTo-client svelte-lswt2h">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${validate_component(Text, "Text").$$render(
        $$result,
        {
          size: innerWidth > 1880 ? "h3" : "h4",
          text: clientName
        ...
        {}
                        ...
                        <div class="bottomCard_invoiceInfo-billTo-client-information svelte-lswt2h">${validate_component(Text, "Text").$$render(
        $$result,
        {
          size: innerWidth > 1880 ? "h3" : "p",
          text: clientAddress.street
        },
        {},
        {}
      )}
        ...
        default: () => {
          return `${each(items, (item, i) => {
            return `<div class="bottomCard_invoiceInfo-itemList-items svelte-lswt2h"><div class="bottomCard_invoiceInfo-itemList-items-description svelte-lswt2h">${validate_component(Text, "Text").$$render(
              $$result,
              {
                size: innerWidth > 1880 ? "h2" : "h3",
                text: item.name
