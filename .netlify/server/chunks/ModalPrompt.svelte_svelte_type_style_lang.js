...
const css$1 = {
  code: "a.svelte-pg0gis,button.svelte-pg0gis{display:flex;justify-content:center;font-size:0.8125rem;margin:1.5rem 0;cursor:pointer}@media(min-width: 768px){a.svelte-pg0gis,button.svelte-pg0gis{font-size:1.125rem}}i.svelte-pg0gis{color:#7c5dfa;font-weight:bold;margin-right:0.5rem;font-size:1.2rem}@media(min-width: 2000px){i.svelte-pg0gis{font-size:2rem;margin-right:1rem}}",
  map: null
};
const BackButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${href ? `<a href="/" class="svelte-pg0gis"><i class="fas fa-chevron-left svelte-pg0gis"></i>${validate_component(Text, "Text").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</a>` : `<button class="svelte-pg0gis"><i class="fas fa-chevron-left svelte-pg0gis"></i>${validate_component(Text, "Text").$$render(
    $$result,
    {
      size: innerWidth > 1880 ? "h2" : "h3",
      text: "Go back"
