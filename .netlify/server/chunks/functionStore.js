...
const css = {
  code: "a.svelte-1vsuk18.svelte-1vsuk18,button.svelte-1vsuk18.svelte-1vsuk18{display:flex;justify-content:center;align-items:center;padding:0.75rem;width:max-content;font-size:0.875rem;height:3.5rem;cursor:pointer}@media(min-width: 768px){a.svelte-1vsuk18.svelte-1vsuk18,button.svelte-1vsuk18.svelte-1vsuk18{font-size:1rem;min-width:4rem}}@media(min-width: 2000px){a.svelte-1vsuk18.svelte-1vsuk18,button.svelte-1vsuk18.svelte-1vsuk18{font-size:1.25rem;min-width:5rem;height:4.3rem}}a.primary.svelte-1vsuk18.svelte-1vsuk18,button.primary.svelte-1vsuk18.svelte-1vsuk18{background-color:#7c5dfa}a.secondary.svelte-1vsuk18.svelte-1vsuk18,button.secondary.svelte-1vsuk18.svelte-1vsuk18{background-color:#7078b2;color:white}a.accent.svelte-1vsuk18.svelte-1vsuk18,button.accent.svelte-1vsuk18.svelte-1vsuk18{background-color:#7e88C3}a.danger.svelte-1vsuk18.svelte-1vsuk18,button.danger.svelte-1vsuk18.svelte-1vsuk18{background-color:#ec5757}a.fluid.svelte-1vsuk18.svelte-1vsuk18,button.fluid.svelte-1vsuk18.svelte-1vsuk18{width:100% !important}a.svelte-1vsuk18 i.svelte-1vsuk18,button.svelte-1vsuk18 i.svelte-1vsuk18{margin-right:0.7rem;font-size:1.1rem}a.rounded.svelte-1vsuk18.svelte-1vsuk18,button.rounded.svelte-1vsuk18.svelte-1vsuk18{border-radius:1.25rem}a.small.svelte-1vsuk18.svelte-1vsuk18,button.small.svelte-1vsuk18.svelte-1vsuk18{width:5rem}a.medium.svelte-1vsuk18.svelte-1vsuk18,button.medium.svelte-1vsuk18.svelte-1vsuk18{min-width:3rem;max-width:10rem;height:3rem}a.large.svelte-1vsuk18.svelte-1vsuk18,button.large.svelte-1vsuk18.svelte-1vsuk18{width:11.5rem;height:4.3rem}button[disabled].svelte-1vsuk18.svelte-1vsuk18{opacity:0.5}",
  map: null
};
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${!href ? `<button ${disabled ? "disabled" : ""} class="${[
    escape(type, true) + " " + escape(size, true) + " svelte-1vsuk18",
    (rounded ? "rounded" : "") + " " + (fluid ? "fluid" : "")
  ].join(" ").trim()}"><i class="${"fas fa-" + escape(icon, true) + " svelte-1vsuk18"}"></i>${escape(text)}</button>` : `<a class="${escape(null_to_empty(type), true) + " svelte-1vsuk18"}"${add_attribute("href", href, 0)}><i class="${"fas fa-" + escape(icon, true) + " svelte-1vsuk18"}"></i>${escape(text)}</a>`}`;
});
